...
if postProcessFlag
    ...
    %Daq the solution
                                %   ePsi   ey   vx   vy   r  t
    daq = parseGpops2toDaq(output,{'ePsi';'ey';'vx';'vy';'r';'time';'omega_L1';'omega_R1';'omega_L2';'omega_R2';'delta';'torqueDemand'},...
                                  {'u1';'u2'},...
                                  'distance',...
                                  {'rad';'m';'m/s';'m/s';'rad/s';'s';'rad/s';'rad/s';'rad/s';'rad/s';'rad';'N*m';'-';'-';'m'},...
                                  {'Heading Deviation','Lateral Deviation','Longitudinal Speed','Lateral Speed','Yaw Rate','time',...
